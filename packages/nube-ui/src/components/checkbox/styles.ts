...
export const checkbox = tv({
  slots: {
    ...
    container: 'rounded-lg relative z-10 overflow-hidden transition-all duration-300 w-6 h-6 shadow-gray shadow-checkbox hover:bg-gray/40',
    checkmark: 'absolute w-full h-full',
    checkmarkIcon: 'flex items-center justify-center transition-all duration-300 w-6 h-6 [&>span]:rotate-[45deg] [&>span]:block [&>span]:relative [&>span]:w-[8px] [&>span]:h-[13px] [&>span]:-mt-1',
